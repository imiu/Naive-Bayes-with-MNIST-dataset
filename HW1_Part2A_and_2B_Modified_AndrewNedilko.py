...
#and compare with classification results for the original MNIST dataset
#uses ideas from https://gist.github.com/fukuroder/caa351677bf718a8bfe6265c2a45211f
#uses ideas from https://stackoverflow.com/questions/44383209/how-to-detect-edge-and-crop-an-image-in-python
#uses some ideas from https://medium.com/@tenzin_ngodup/digit-prediction-using-multinomial-naive-bayes-in-python-6bf0d73f022e
