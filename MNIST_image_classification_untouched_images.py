...
#suggested by AML Piazza post @131
#some individual code ideas from https://medium.com/@tenzin_ngodup/digit-prediction-using-multinomial-naive-bayes-in-python-6bf0d73f022e
